    ...
    <div className="space-y-5">
      <div className="rounded-xl border border-border bg-surface p-4 shadow-soft">
        <div className="relative max-w-sm">
          ...
          <Input placeholder="Search published content..." value={search} onChange={(e) => { setSearch(e.target.value); setPage(1); }} className="pl-9 h-9 rounded-[10px] text-[13px] border-border bg-surface focus-visible:ring-1 focus-visible:ring-ring" />
        </div>
      </div>
      <div className="rounded-xl border border-border bg-surface shadow-soft overflow-hidden">
        ...
        {allPublished.length === 0 && <div className="p-16 text-center text-[13px] text-muted-foreground">No published content found.</div>}
