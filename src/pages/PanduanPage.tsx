  ...
  return (
    <div className="space-y-5">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-lg font-semibold text-foreground">Panduan</h1>
          <p className="text-[13px] text-muted-foreground mt-0.5">Kelola artikel panduan dan help center</p>
        </div>
      ...
      <div className="rounded-[12px] border border-border bg-surface shadow-card overflow-hidden">
          ...
          <table className="w-full text-[13px]">
            <thead>
              <tr className="border-b border-border/60">
                <th className="px-5 py-3.5 text-left text-[11px] font-medium uppercase tracking-[0.08em] text-muted-foreground">Judul</th>
                ...
                <th className="px-5 py-3.5 text-left text-[11px] font-medium uppercase tracking-[0.08em] text-muted-foreground">Terakhir Diupdate</th>
            ...
            <tbody>
              {paged.map((g) => (
                <tr key={g.id} className="border-b border-border/30 hover:bg-accent/30 transition-colors duration-150">
                  <td className="px-5 py-4 font-medium text-foreground max-w-[320px] leading-[1.4]">{g.title}</td>
        ...
        {filtered.length === 0 && <div className="p-16 text-center text-[13px] text-muted-foreground">Tidak ada panduan ditemukan.</div>}
        {totalPages > 0 && (
