...
const mockDocCategories: DocCategory[] = [
  { id: "dc1", name: "Peraturan Perkumpulan", isPublished: true },
  { id: "dc2", name: "Konbes NU", isPublished: true },
  { id: "dc3", name: "Rencana Strategis", isPublished: true },
  { id: "dc4", name: "Digitalisasi", isPublished: true },
  { id: "dc5", name: "Lain-lain", isPublished: true },
  { id: "dc6", name: "Harlah NU", isPublished: false },
];
    ...
    <div className="space-y-4 md:space-y-5">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
        <div>
          ...
          <p className="text-[12px] md:text-[13px] text-muted-foreground mt-0.5">Kelola kategori dokumen</p>
        </div>
              ...
              <div key={cat.id} className="p-4 hover:bg-accent/30 transition-colors">
                <div className="flex items-start justify-between gap-3">
                  <div className="flex-1 min-w-0">
                    ...
                    >
                      <span className={cn("h-1.5 w-1.5 rounded-full", cat.isPublished ? "bg-[hsl(var(--status-success-fg))]" : "bg-muted-foreground/50")} />
                      {cat.isPublished ? "Published" : "Unpublished"}
                    </span>
                  </div>
                  <Link to={`/categories/dokumen/${cat.id}`} className="flex items-center gap-1 text-[12px] font-medium text-primary hover:text-primary/80 transition-colors shrink-0">
