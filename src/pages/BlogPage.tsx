...
import { Search, Eye, Plus, PenSquare } from "lucide-react";
    ...
    <div className="space-y-5">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-[13px] text-muted-foreground mt-0.5">Kelola artikel blog dan editorial</p>
        </div>
      ...
      <div className="rounded-[12px] border border-border bg-surface shadow-card overflow-hidden">
          ...
          <table className="w-full text-[13px]">
            <thead>
              <tr className="border-b border-border/60">
                ...
                <th className="px-5 py-3.5 text-left text-[11px] font-medium uppercase tracking-[0.08em] text-muted-foreground">Penulis</th>
                <th className="px-5 py-3.5 text-left text-[11px] font-medium uppercase tracking-[0.08em] text-muted-foreground">Status</th>
                <th className="px-5 py-3.5 text-center text-[11px] font-medium uppercase tracking-[0.08em] text-muted-foreground">Unggulan</th>
        ...
        {filtered.length === 0 && <div className="p-16 text-center text-[13px] text-muted-foreground">Tidak ada artikel ditemukan.</div>}
        {totalPages > 0 && (
