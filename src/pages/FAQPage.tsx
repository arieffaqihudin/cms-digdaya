...
import { Search, Plus, Pencil, HelpCircle, Filter } from "lucide-react";
...
const mockFAQItems: FAQItem[] = [
  { id: "fq1", title: "Bagaimana cara mendaftar akun Digdaya Persuratan?", slug: "cara-mendaftar-akun-digdaya-persuratan", category: "Pendaftaran & Akun", product: "Digdaya Persuratan", status: "published" },
  { id: "fq2", title: "Bagaimana cara reset password?", slug: "cara-reset-password", category: "Pendaftaran & Akun", product: "Digdaya Persuratan", status: "published" },
  { id: "fq3", title: "Metode pembayaran apa saja yang tersedia?", slug: "metode-pembayaran-tersedia", category: "Pembayaran", product: "Digdaya Persuratan", status: "published" },
  { id: "fq4", title: "Bagaimana cara mengajukan refund?", slug: "cara-mengajukan-refund", category: "Pembayaran", product: "Digdaya Persuratan", status: "draft" },
  { id: "fq5", title: "Apa saja fitur utama Digdaya Persuratan?", slug: "fitur-utama-digdaya-persuratan", category: "Fitur Utama", product: "Digdaya Persuratan", status: "published" },
  { id: "fq6", title: "Bagaimana cara mengelola surat masuk?", slug: "cara-mengelola-surat-masuk", category: "Fitur Utama", product: "Digdaya Persuratan", status: "published" },
  { id: "fq7", title: "Aplikasi error saat login, bagaimana solusinya?", slug: "aplikasi-error-saat-login", category: "Teknis & Troubleshoot", product: "Digdaya Persuratan", status: "archived" },
  { id: "fq8", title: "Bagaimana cara mendaftarkan santri baru?", slug: "cara-mendaftarkan-santri-baru", category: "Manajemen Santri", product: "Digdaya Pesantren", status: "published" },
  { id: "fq9", title: "Bagaimana cara mengatur kurikulum pesantren?", slug: "cara-mengatur-kurikulum-pesantren", category: "Kurikulum", product: "Digdaya Pesantren", status: "published" },
  { id: "fq10", title: "Bagaimana cara input data kader?", slug: "cara-input-data-kader", category: "Pendataan Kader", product: "Siskader NU", status: "published" },
  { id: "fq11", title: "Bagaimana cara verifikasi data kader?", slug: "cara-verifikasi-data-kader", category: "Pendataan Kader", product: "Siskader NU", status: "draft" },
  { id: "fq12", title: "Bagaimana cara membuat surat keluar?", slug: "cara-membuat-surat-keluar", category: "Surat & Disposisi", product: "Digdaya Kepengurusan", status: "published" },
  { id: "fq13", title: "Bagaimana cara disposisi surat?", slug: "cara-disposisi-surat", category: "Surat & Disposisi", product: "Digdaya Kepengurusan", status: "published" },
        ...
        {screenSize === "mobile" ? (
          ...
          <div className="overflow-x-auto">
            <table className="w-full text-[13px]">
              ...
              <tbody>
                {paged.map((faq) => (
                  <tr key={faq.id} className="border-b border-border/30 hover:bg-accent/30 transition-colors duration-150">
