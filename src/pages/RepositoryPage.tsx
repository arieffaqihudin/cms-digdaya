...
const initialItems: RepoItem[] = [
  { id: "r1", nama: "AD/ART NU 2022", kategori: "Peraturan Perkumpulan", kepengurusan: "PBNU", createdAt: "2025-03-20", updatedAt: "2025-03-22", orderIndex: 0 },
  { id: "r2", nama: "Hasil Konbes NU 2024", kategori: "Konbes NU", kepengurusan: "PBNU", createdAt: "2025-03-18", updatedAt: "2025-03-18", orderIndex: 1 },
  { id: "r3", nama: "Renstra NU 2025-2030", kategori: "Rencana Strategis", kepengurusan: "PBNU", createdAt: "2025-03-15", updatedAt: "2025-03-20", orderIndex: 2 },
  { id: "r4", nama: "Blueprint Digitalisasi NU", kategori: "Digitalisasi", kepengurusan: "Lembaga Pendidikan NU", createdAt: "2025-03-12", updatedAt: "2025-03-15", orderIndex: 3 },
  { id: "r5", nama: "Panduan Harlah NU ke-103", kategori: "Harlah NU", kepengurusan: "PWNU Jawa Timur", createdAt: "2025-03-10", updatedAt: "2025-03-14", orderIndex: 4 },
  { id: "r6", nama: "PO/PD NU 2023", kategori: "Peraturan Perkumpulan", kepengurusan: "PBNU", createdAt: "2025-03-09", updatedAt: "2025-03-09", orderIndex: 5 },
  { id: "r7", nama: "Rekomendasi Konbes Alim Ulama", kategori: "Konbes NU", kepengurusan: "PBNU", createdAt: "2025-03-08", updatedAt: "2025-03-10", orderIndex: 6 },
  { id: "r8", nama: "Laporan Digitalisasi Pesantren", kategori: "Digitalisasi", kepengurusan: "PWNU Jawa Tengah", createdAt: "2025-03-05", updatedAt: "2025-03-07", orderIndex: 7 },
  { id: "r9", nama: "Dokumen Pendukung Lainnya", kategori: "Lain-lain", kepengurusan: "PCNU Surabaya", createdAt: "2025-03-03", updatedAt: "2025-03-03", orderIndex: 8 },
  { id: "r10", nama: "Susunan Acara Harlah NU 2025", kategori: "Harlah NU", kepengurusan: "PWNU Jawa Barat", createdAt: "2025-03-01", updatedAt: "2025-03-02", orderIndex: 9 },
];

const ITEMS_PER_PAGE = 10;

export default function RepositoryPage() {
  const [items, setItems] = useState<RepoItem[]>(initialItems);
          ...
          <SortableContext items={paged.map((i) => i.id)} strategy={verticalListSortingStrategy}>
            {screenSize === "mobile" ? (
              <div className="divide-y divide-border/30">
                {paged.map((item) => (
                  <SortableMobileCard key={item.id} id={item.id}>
