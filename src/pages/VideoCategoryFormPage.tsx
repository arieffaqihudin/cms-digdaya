...
export default function VideoCategoryFormPage() {
  ...
  const handleSave = () => {
    ...
    toast.success("Kategori Video berhasil disimpan");
    navigate("/categories/video");
  };
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-3">
          <Button
            variant="ghost"
            size="icon"
            onClick={() => navigate("/categories/video")}
          ...
          <div className="flex items-center gap-2">
            ...
            <h1 className="text-lg font-semibold text-foreground/90">Tambah Kategori Video</h1>
          </div>
        </div>
        <Button
          size="sm"
      ...
      <div className="rounded-[12px] border border-border/60 bg-card p-6 space-y-6">
        <div className="space-y-2">
          ...
          <Input
            placeholder="Masukkan nama kategori video..."
            value={name}
        ...
        <div className="flex items-center justify-between pt-2 border-t border-border/60">
          <div>
            <p className="text-[13px] font-medium text-foreground">Is Active</p>
